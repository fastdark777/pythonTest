...
#my def
def total_enrollment_1(univ):
    totalEnrol=0
    totalfee=0
    
    for outU in univ:
            totalEnrol=totalEnrol+outU[1]
            totalfee=totalfee+(outU[2]*outU[1])
            
    return totalEnrol, totalfee
...
def total_enrollment(univ):
    ...
    for name, students, price in univ:
            totalEnrol=totalEnrol+students
            totalfee=totalfee+(students*price)
